...
<button class="collapsible">Expressing the existence of an event with ‘<i>you</i> (to have) + VP’ in Taiwan Mandarin: A corpus-based investigation. (Collart & Su, 2022)
</button>
<div class="content">
	<p><b>Abstract</b></p>
	...
	<p>Link to the article: <a href="https://doi.org/10.1075/consl.21046.col" target="_blank">Click here</a></p>
</div>
